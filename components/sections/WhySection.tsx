...
import { whyDenali } from "@/data/site";
  ...
  return (
    <section className="py-16 sm:py-20">
      <div className="container-pad grid gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
        <SectionHeader
          eyebrow="Why Denali Tech"
          title="Practical strategy, serious engineering, and product-minded execution"
          description="Denali Tech is built for organizations that need more than a prototype. We connect business goals, AI capabilities, secure architecture, and scalable software delivery."
        />
