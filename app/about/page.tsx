...
import { capabilities, whyDenali } from "@/data/site";
...
export const metadata: Metadata = {
  title: "About",
  description:
    "Learn about Denali Tech, a modern software and AI consulting company focused on scalable digital solutions, intelligent automation, and product-minded engineering."
};
...
export default function AboutPage() {
  return (
    <>
      <PageHero
        eyebrow="About Denali Tech"
        title="A modern consulting partner for AI-first software delivery"
        description="Denali Tech helps businesses plan, build, and improve software systems that connect strategy with execution: AI workflows, automation, geospatial products, dashboards, platforms, and cloud infrastructure."
      />
      ...
      <section className="py-16 sm:py-20">
        <div className="container-pad">
          <SectionHeader
            ...
            description="Denali Tech is positioned to serve startups, healthcare organizations, local businesses, and enterprises that need credible technology delivery without unnecessary ceremony."
          />
