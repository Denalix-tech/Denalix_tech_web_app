  ...
  return (
    <>
      <PageHero
        ...
        description="Denali Tech designs AI applications that combine LLMs, retrieval, data pipelines, human approval, and tool orchestration so teams can automate work without losing control."
      />
      <FeatureGrid
