...
export const metadata: Metadata = {
  title: "Contact",
  description:
    "Contact Denalix Tech to discuss AI systems, automation workflows, custom software, GIS platforms, analytics dashboards, and SaaS product development."
};
          ...
          <aside className="space-y-6">
            <div>
              ...
              <p className="mt-4 text-base leading-7 text-slate-300">
                ...
                should look like. Denalix Tech will help identify the right project
                shape and next steps.
              </p>
            </div>
            <div className="grid gap-4">
              <a href="mailto:hello@denalixtech.ai" className="flex items-center gap-4 rounded-lg border border-white/10 bg-white/[0.04] p-5 text-slate-200 hover:border-cyan-300/40">
